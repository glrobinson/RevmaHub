        ...
        <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-10 text-sm">
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><Link href="/stories" className="hover:underline text-gray-700">Teaching Roma</Link></li>
              <li><Link href="/resources" className="hover:underline text-gray-700">Resource Archive</Link></li>
              <li><Link href="/info" className="hover:underline text-gray-700">Learn More</Link></li>
              <li>
          ...
          <div>
            ...
            <ul className="space-y-2 text-gray-700">
              <li className="flex items-center gap-2">📞 <span>Phone: 694 388 4290</span></li>
      ...
      {showContributors && (
        <div className="fixed inset-0 z-50 flex items-center justify-center backdrop-blur-sm bg-black/30">
          ...
          <button
            ...
            <h2 className="text-2xl sm:text-3xl font-semibold mb-6">Meet the Contributors</h2>
